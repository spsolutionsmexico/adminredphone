...
class condblib {
    ...
    insertardata(columnas, datos, callback) {
        ...
        client.connect();
        console.log("Database connection ready");
        client.query("INSERT INTO public.\"USUARIO\" (fbId,nombre,fechaActualizacion,codigo,anoNacimiento,codigoPostal) values($1, $2, $3, $4, $5, $6)", ['123', 'panchito', '2017-11-07', 'abc', '1985', '7010'], (err, resDB) => {
            if (err) {
                console.log(JSON.stringify(err));
                throw err;
            }
